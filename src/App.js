              ...
              <div className="card-block">
                ...
                <form onSubmit ={this.handleFormSubmit}>
                  <div className="form-group">
                    <textarea className="form-control" name="comment" value={this.state.commentText}  rows="3" type="text" onChange={this.handleCommentTextChange}  />
                  </div>
                  <div className="form-group">
                    <input value={this.state.name}  className="form-control col-md-3" name="name" onChange={this.handleNameChange}  type="text"/>
                  </div>
